#
#  Be sure to run `pod spec lint PBTabBarController.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                         Supports TabBarController to add custom button, written by Objective-C.
                   DESC
  ...
  s.source       = { :git => "https://github.com/JpacheGitHub/PBTabBarController.git", :tag => "#{s.version}" }
